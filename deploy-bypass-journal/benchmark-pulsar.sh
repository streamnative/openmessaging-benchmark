...
sudo bin/benchmark --drivers driver-pulsar/pulsar-batched-1ms-linger-1mb-ack-1.yaml workloads/backlog-1-topic-100-partitions-1kb-200k-rate.yaml -o pulsar-backlog-100-partitions-1kb-batched-1ms-ack-1-bypass-journal.json
sudo bin/benchmark --drivers driver-pulsar/pulsar-batched-1ms-linger-1mb-ack-2.yaml workloads/backlog-1-topic-100-partitions-1kb-200k-rate.yaml -o pulsar-backlog-100-partitions-1kb-batched-1ms-ack-2-bypass-journal.json
