...
sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-1-sync.yaml workloads/backlog-1-topic-100-partitions-1kb-200k-rate.yaml -o kafka-backlog-100-partitions-1kb-batched-1ms-ack-1-sync.json
sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-all-sync.yaml workloads/backlog-1-topic-100-partitions-1kb-200k-rate.yaml -o kafka-backlog-100-partitions-1kb-batched-1ms-ack-all-sync.json

sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-1-sync.yaml workloads/1-topic-100-partitions-1kb.yaml -o kafka-100-partitions-1kb-batched-1ms-1mb-ack-1-10-sub-sync.json
sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-all-sync.yaml workloads/1-topic-100-partitions-1kb.yaml -o kafka-100-partitions-1kb-batched-1ms-1mb-ack-all-10-sub-sync.json
sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-1-nosync.yaml workloads/1-topic-100-partitions-1kb.yaml -o kafka-100-partitions-1kb-batched-1ms-1mb-ack-1-10-sub-nosync.json
sudo bin/benchmark --drivers driver-kafka/kafka-batched-1ms-1mb-ack-all-nosync.yaml workloads/1-topic-100-partitions-1kb.yaml -o kafka-100-partitions-1kb-batched-1ms-1mb-ack-all-10-sub-nosync.json
